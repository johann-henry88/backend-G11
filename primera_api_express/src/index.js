...
// json() > sirve para indicar que mi aplicacion podra 'entender' los JSON entrantes por el body y lo convertira a un JSON
...
servidor
  ...
  .post((req, res) => {
    ...
    // convierte el JSON a un string y por ende si el valor es '{}' significa que esta vacio
    // if (JSON.stringify(req.body) === "{}") {
    // { nombre : 'Johann' } > Object.keys({...}) > ['nombre', '...']
...
servidor.route("/buscar-productos").get((req, res) => {
    ...
    if (req.query.patron){
        resultado = productos.filter((producto) => {
            //p podemos utilizar expresiones regulares para hacer busqueda de patrones
