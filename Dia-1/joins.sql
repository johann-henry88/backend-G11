...
-- Hacer un inner join entre la tabla alumnos y la tabla alumnos_cursos
-- Hacer un inner join entre la tabla cursos y la tabla alumnos_cursos
...
--Si queremos colocar alias a los nombres de las tablas seria de la sgt manera:
...
--SELECCIONAR los nombres y apellidos de los alumnos que tenga el curso de comunicacion
...
--SELECCIONAR los alumnos curos cursos esten habilitados (true)
