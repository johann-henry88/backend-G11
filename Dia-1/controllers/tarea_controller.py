...
class TareaController(Resource):
    @jwt_required()
    def get(self):
        # TODO: utilizando query params poder recibir el nombre, fecha_vencimiento o el estado y devolver solamente esas tareas con esos filtros especializados
        # /tarea?nombre=Ir a la piscina
        # /tarea?estado=REALIZANDOSE
        # /tarea?fecha:vencimiento=2023-07-31 14:55:25
