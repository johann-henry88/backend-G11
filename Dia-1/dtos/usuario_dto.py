...
class UsuarioDto(SQLAlchemyAutoSchema):
    ...
    # load_only > solamente este campo sera necesario para cuando querramos validar la informacion entrante, pero si queremos devolver informacion este campo se omitira
    ...
    class Meta:
        ...
        class LoginDto(Schema):
            # validar el siguiente patron (expresion regular) xxxxxxx@xxxxx.xx
