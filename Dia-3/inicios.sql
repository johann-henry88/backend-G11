...
('MASCULINO', 'FEMENINO', 'PANSEXUAL', 'DONUTSEXUAL', 'OTRES');
...
SELECT * FORM alumnos WHERE sexo='MASCULINO';

--SELECCIONA todos los alumnos cuyo sexo sea masculino y la matricula sea verdadera
...
-- SELECCIONA todos los alumnos cuyo nombre en la tercera posicion tenga la letra "o"
...
SELECT * FROM direcciones WHERE alumno_id LIKE 'Calle %' OR referencia NOT IS NULL AND alumno_id = 1;
