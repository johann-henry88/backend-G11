...
SECRET_KEY = 'django-insecure-gql6gek=!=x_@qe^!m7q*uctl45z^9xj*w+gs98uc!vr@b@xz#'
...
INSTALLED_APPS = [
    ...
    'gestion',
    # sirve para indicar que ahora vamos a poder acceder a todos los recursos DRF
    'rest_framework',
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'powermusic', # la contraseña de la base de datos
...
REST_FRAMEWORK = {
    # PAGE_SIZE > para indicar cuantos elememtos vamos a retornar por cada pagina
    'PAGE_SIZE': 3,
