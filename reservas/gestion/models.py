...
class Producto(models.Model):
    ...
    # createdAt > es elcampo que automaticamente registrara la hora y fecha del servidor cuando se cree un nuevo registro
    ...
    updatedAt = models.DecimalField(auto_now=True, db_column='updated_at')
    ...
    class Meta:
        ...
        db_table = 'productos'
        # vas a modificar el ordenamiento y sera primero el nombre de manera descendente y luego si es que hay una coincidencia en los nombres ordenara esa coincidencia basandote ahora en el precio de manera ascendente
