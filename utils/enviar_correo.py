...
>
  ...
  >
    ...
    # Agregando el cuerpo pero con un html
    ...
    # cerrar la conexion con mi servidor de correo
    emisor.quit()


def enviar_correo_adjunto(destinatarios, titulo):
    cuerpo = 'Por fabor, revisa los archivos adjuntos'
    mensaje = MIMEMultipart()
    email_emisor = environ.get('EMAIL_SENDER')
    password_email_emisor = environ.get('PASSWORD_SENDER')
